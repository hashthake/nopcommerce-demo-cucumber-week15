...
public class RegisterPage extends Utility {
    ...
    public void selectDateOfBirth(String day, String month, String year) {
        ...
        log.info("Select date of Birth" + dateOfBirthDay.toString() + dateOfBirthMonth.toString()+ dateOfBirthYear.toString());
    }
    ...
    public String getYourRegCompletedText() {
        ...
        log.info("Register completed text" + yourRegCompletedText.toString());
        return message;
    }
